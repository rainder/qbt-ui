...
export function TorrentCard({
  ...
  return (
    <div
      ...
      className={clsx(
        'flex flex-col gap-1 px-3 py-2 border-b border-border-muted cursor-default',
    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        ...
        {!complete && <div className="shrink-0 tabular-nums text-xs text-fg-muted">{pct}%</div>}
      ...
      <div className="flex items-center gap-2 text-xs text-fg-muted min-w-0">
        <div className="shrink-0 w-16"><ProgressBar value={progress} complete={complete} thin /></div>
